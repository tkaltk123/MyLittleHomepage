...
import com.yunseojin.MyLittleHomepage.v2.post.domain.QSearchedPost;
...
public class DslSearchedPostRepositoryImpl extends QuerydslRepositorySupport implements
    ...
    private static final QSearchedPost p = QSearchedPost.searchedPost;

    public DslSearchedPostRepositoryImpl() {
        super(SearchedPost.class);
    }


    @Override
    public Page<SearchedPost> getPosts(PostSearchVo postSearchVo, Pageable pageable) {
    ...
    private List<SearchedPost> getPostList(BooleanExpression condition, boolean isAsc,
            Pageable pageable) {
    ...
    @Override
    public Page<SearchedPost> getPostsWithCursor(PostSearchVo postSearchVo, boolean isAsc,
    ...
    @Override
    public List<SearchedPost> getOrderedPostsLimit(Long boardId, PostOrderType postOrderType,
            int limit) {
