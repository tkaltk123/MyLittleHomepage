package com.yunseojin.MyLittleHomepage.domain.member.command.model;

import com.yunseojin.MyLittleHomepage.domain.contract.command.model.BaseAggregateRoot;
import com.yunseojin.MyLittleHomepage.domain.member.command.event.MemberCreatedEvent;
import com.yunseojin.MyLittleHomepage.domain.member.command.event.MemberDeletedEvent;
import com.yunseojin.MyLittleHomepage.domain.member.command.event.MemberUpdatedEvent;
